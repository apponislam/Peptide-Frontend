...
// import { ArrowLeft, Package, Truck, User, CreditCard, MapPin, Phone, Tag, ExternalLink } from "lucide-react";
...
//     if (isLoading) {
//         return (
//             <div className="min-h-screen bg-linear-to-b from-slate-900 to-slate-950 p-6">
...
//     return (
//         <div className="min-h-screen bg-linear-to-b from-slate-900 to-slate-950 p-4 md:p-6">
//             <div className="max-w-6xl mx-auto">
//                 {/* Header */}
//                 <div className="mb-8">
//                     <div className="flex items-center gap-4 mb-6">
//                         <Link href="/admin?tab=orders" className="p-2 bg-slate-800 hover:bg-slate-700 rounded-lg">
...
//                                 <span className="text-gray-400">Created:</span> {new Date(order.createdAt).toLocaleDateString()} {new Date(order.createdAt).toLocaleTimeString()}
//                             </div>
//                             {order.trackingNumber && (
//                                 <div className="text-cyan-400">
//                                     <span className="text-gray-400">Tracking:</span> {order.trackingNumber}
//                                 </div>
//                             )}
//                         </div>
...
//                             <select value={order.status} onChange={(e) => handleUpdateStatus(e.target.value)} className="px-3 py-1.5 bg-slate-900 border border-slate-700 rounded-lg text-white text-sm">
...
//                                         <p className="text-white">{order.user?.name || order.name}</p>
//                                     </div>
//                                     <div>
//                                         <p className="text-sm text-gray-400">Email</p>
//                                         <p className="text-white">{order.user?.email || order.email}</p>
//                                     </div>
//                                     <div>
...
//                                         <p className="text-white">{order.user?.tier || "Member"}</p>
//                                     </div>
//                                 </div>
//                             </div>
...
//                                                 <p className="text-sm text-gray-400">Product ID: {item.product?.id}</p>
...
//                                     <p className="text-gray-400">Payment Intent: {order.paymentIntentId}</p>
//                                     <p className="text-gray-400">Commission: ${order.commissionAmount?.toFixed(2) || "0.00"}</p>
//                                 </div>
//                             </div>
//                         </div>
...
//                                     <button onClick={handleAddTracking} className="px-4 py-2 bg-green-600 hover:bg-green-700 rounded-lg font-medium">
//                                         Add
//                                     </button>
//                                 </div>
//                             </div>
...
//                                     <select value={carrier} onChange={(e) => setCarrier(e.target.value)} className="w-full px-3 py-2 bg-slate-900 border border-slate-700 rounded-lg text-white text-sm">
...
//                                     <select value={service} onChange={(e) => setService(e.target.value)} className="w-full px-3 py-2 bg-slate-900 border border-slate-700 rounded-lg text-white text-sm">
...
//                             <div className="space-y-3">
//                                 {!hasShipStationOrder ? (
//                                     <button onClick={handleCreateShipStationOrder} className="w-full px-4 py-3 bg-cyan-600 hover:bg-cyan-700 rounded-lg font-medium flex items-center justify-center gap-2">
//                                         <Package className="w-5 h-5" />
//                                         Create ShipStation Order
//                                     </button>
//                                 ) : (
//                                     <button onClick={handleCreateLabel} className="w-full px-4 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg font-medium flex items-center justify-center gap-2">
...
//                                 {order.labelUrl && (
//                                     <button onClick={handleOpenLabel} className="w-full px-4 py-3 bg-green-600 hover:bg-green-700 rounded-lg font-medium flex items-center justify-center gap-2">
...
//                         <button onClick={() => router.back()} className="px-6 py-3 bg-slate-800 hover:bg-slate-700 rounded-lg font-medium">
//                             Back
//                         </button>
//                         <Link href="/admin?tab=orders" className="px-6 py-3 bg-cyan-600 hover:bg-cyan-700 rounded-lg font-medium">
//                             Back to Orders List
...
import { useCreateShipStationLabelMutation, useCreateShipStationOrderMutation, useMarkAsShippedMutation } from "@/app/redux/features/shipment/shipmentApi";
import Link from "next/link";
import { ArrowLeft, Package, Truck, User, CreditCard, MapPin, Phone, Tag, ExternalLink, Calendar } from "lucide-react";
