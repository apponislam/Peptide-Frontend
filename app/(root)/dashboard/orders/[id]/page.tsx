...
//                                 ← Go Back
//                             </button>
//                             <button onClick={handleDirectCheckout} disabled={!isRepeat || isLoadingAction} className={`inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg font-semibold transition ${isRepeat && !isLoadingAction ? "bg-cyan-500 hover:bg-cyan-600 text-white" : "bg-gray-600 text-gray-400 cursor-not-allowed opacity-50"}`}>
//                                 <span>🔄</span>
...
export default function OrderDetailsPage() {
    ...
    const { data, isLoading, error: orderError } = useGetOrderQuery(orderId);
    ...
    // Combine loading states
    const isLoadingAction = isProductsLoading || isRepeating;
                ...
                <div className="mb-8">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div className="flex flex-col sm:flex-row gap-2">
                            ...
                            <button onClick={handleRepeatOrder} disabled={isLoadingAction} className={`inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg font-semibold transition ${!isLoadingAction ? "bg-cyan-500 hover:bg-cyan-600 text-white" : "bg-gray-600 text-gray-400 cursor-not-allowed opacity-50"}`}>
                                <span>🔄</span>
