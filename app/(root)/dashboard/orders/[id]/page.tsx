...
//                                 ← Go Back
//                             </button>
//                             <button onClick={handleDirectCheckout} disabled={!isRepeat || isCheckoutLoading} className={`inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg font-semibold transition ${isRepeat && !isCheckoutLoading ? "bg-cyan-500 hover:bg-cyan-600 text-white" : "bg-gray-600 text-gray-400 cursor-not-allowed opacity-50"}`}>
//                                 <span>🔄</span>
