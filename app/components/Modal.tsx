...
// const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, message, type = "info", confirmText = "OK", cancelText = "Cancel", onConfirm, onCancel, showCloseButton = true, showConfirmButton = true, showCancelButton = false, isLoading = false, isDestructive = false, children }) => {
...
//     // Auto-set confirm/cancel button visibility based on type
