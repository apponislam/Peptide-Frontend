                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-6">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="relative">
                            ...
                            <input type={showCurrentPassword ? "text" : "password"} {...register("currentPassword")} className="w-full pl-10 pr-12 py-3 bg-slate-900 border border-slate-700 rounded-lg text-white focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 outline-none" placeholder="Enter current password" disabled={isLoading || success !== ""} />
                    ...
                    <div className="mb-4">
                        ...
                        <div className="relative">
                            ...
                            <input type={showNewPassword ? "text" : "password"} {...register("newPassword")} className="w-full pl-10 pr-12 py-3 bg-slate-900 border border-slate-700 rounded-lg text-white focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 outline-none" placeholder="Enter new password" disabled={isLoading || success !== ""} />
                    ...
                    <div className="mb-6">
                        ...
                        <div className="relative">
                            <KeyRound className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-500" />
                            <input type={showConfirmPassword ? "text" : "password"} {...register("confirmPassword")} className="w-full pl-10 pr-12 py-3 bg-slate-900 border border-slate-700 rounded-lg text-white focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 outline-none" placeholder="Confirm new password" disabled={isLoading || success !== ""} />
                    ...
                    <div className="mb-6 p-3 bg-slate-900/50 rounded-lg">
                        ...
                        <p className="text-xs text-gray-500 mt-2">Minimum 6 characters required. Adding more complexity makes your password stronger.</p>
                    </div>
